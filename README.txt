...
To run the UNET model, uncompress UNET.7z, mode the data into that folder, and run the training.py script inside.
To run the Resnet-18 model, uncompress ResNet.zip, mode the data into that folder, and run the training.py script inside.
